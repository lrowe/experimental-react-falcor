...
'use strict';var g=require("object-assign"),l=require("react"),m=require("react-dom");function n(a,b,c,e,d,k,f,h){if(!a){a=void 0;if(void 0===b)a=Error("Minified exception occurred; use the non-minified dev environment for the full error message and additional helpful warnings.");else{var O=[c,e,d,k,f,h],P=0;a=Error(b.replace(/%s/g,function(){return O[P++]}));a.name="Invariant Violation"}a.framesToPop=1;throw a;}}
...
function z(a){a instanceof this?void 0:n(!1,"Trying to release an event instance into a pool of a different type.");a.destructor();10>this.eventPool.length&&this.eventPool.push(a)}function x(a){a.eventPool=[];a.getPooled=y;a.release=z}var A=!("undefined"===typeof window||!window.document||!window.document.createElement);function B(a,b){var c={};c[a.toLowerCase()]=b.toLowerCase();c["Webkit"+a]="webkit"+b;c["Moz"+a]="moz"+b;return c}
...
function F(a){if(D[a])return D[a];if(!C[a])return a;var b=C[a],c;for(c in b)if(b.hasOwnProperty(c)&&c in E)return D[a]=b[c];return a}var G=F("animationend"),H=F("animationiteration"),I=F("animationstart"),J=F("transitionend"),K=m.findDOMNode,L=m.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,M=L.EventPluginHub,N=L.EventPluginRegistry,Q=L.EventPropagators,R=L.ReactControlledComponent,S=L.ReactDOMComponentTree,T=L.ReactDOMEventListener;function U(){}
function aa(a,b){if(!a)return[];a=t(a);if(!a)return[];for(var c=a,e=[];;){if(5===c.tag||6===c.tag||2===c.tag||1===c.tag){var d=c.stateNode;b(d)&&e.push(d)}if(c.child)c.child.return=c,c=c.child;else{if(c===a)return e;for(;!c.sibling;){if(!c.return||c.return===a)return e;c=c.return}c.sibling.return=c.return;c=c.sibling}}}
function V(a,b){if(a&&!a._reactInternalFiber){var c=""+a;a=Array.isArray(a)?"an array":a&&1===a.nodeType&&a.tagName?"a DOM node":"[object Object]"===c?"object with keys {"+Object.keys(a).join(", ")+"}":c;n(!1,"%s(...): the first argument must be a React class instance. Instead received: %s.",b,a)}}
...
b){return W.isCompositeComponent(a)?a._reactInternalFiber.type===b:!1},findAllInRenderedTree:function(a,b){V(a,"findAllInRenderedTree");return a?aa(a._reactInternalFiber,b):[]},scryRenderedDOMComponentsWithClass:function(a,b){V(a,"scryRenderedDOMComponentsWithClass");return W.findAllInRenderedTree(a,function(a){if(W.isDOMComponent(a)){var c=a.className;"string"!==typeof c&&(c=a.getAttribute("class")||"");var d=c.split(/\s+/);Array.isArray(b)||(void 0===b?p("11"):void 0,b=b.split(/\s+/));return b.every(function(a){return-1!==
...
function ba(a){return function(b,c){l.isValidElement(b)?p("228"):void 0;W.isCompositeComponent(b)?p("229"):void 0;var e=N.eventNameDispatchConfigs[a],d=new U;d.target=b;d.type=a.toLowerCase();var k=S.getInstanceFromNode(b),f=new w(e,k,d,b);f.persist();g(f,c);e.phasedRegistrationNames?Q.accumulateTwoPhaseDispatches(f):Q.accumulateDirectDispatches(f);m.unstable_batchedUpdates(function(){R.enqueueStateRestore(b);M.runEventsInBatch(f,!0)});R.restoreStateIfNeeded()}}
function X(){W.Simulate={};var a=void 0;for(a in N.eventNameDispatchConfigs)W.Simulate[a]=ba(a)}var ca=M.injection.injectEventPluginOrder;M.injection.injectEventPluginOrder=function(){ca.apply(this,arguments);X()};var da=M.injection.injectEventPluginsByName;M.injection.injectEventPluginsByName=function(){da.apply(this,arguments);X()};X();
function ea(a,b){return function(c,e){var d=new U(a);g(d,e);W.isDOMComponent(c)?(c=K(c),d.target=c,T.dispatchEvent(b,d)):c.tagName&&(d.target=c,T.dispatchEvent(b,d))}}
...
"touchStart"],[J,"transitionEnd"],["volumechange","volumeChange"],["waiting","waiting"],["wheel","wheel"]].forEach(function(a){var b=a[1];W.SimulateNative[b]=ea(b,a[0])});var Y={default:W},Z=Y&&W||Y;module.exports=Z.default?Z.default:Z;
