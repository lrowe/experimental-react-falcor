...
D.extend=function(a){function b(){}function c(){return f.apply(this,arguments)}var f=this;b.prototype=f.prototype;var e=new b;k(e,c.prototype);c.prototype=e;c.prototype.constructor=c;c.Interface=k({},f.Interface,a);c.extend=f.extend;E(c);return c};E(D);function ea(a,b,c,f){if(this.eventPool.length){var e=this.eventPool.pop();this.call(e,a,b,c,f);return e}return new this(a,b,c,f)}
function fa(a){a instanceof this?void 0:l(!1,"Trying to release an event instance into a pool of a different type.");a.destructor();10>this.eventPool.length&&this.eventPool.push(a)}function E(a){a.eventPool=[];a.getPooled=ea;a.release=fa}var F=D.extend({touchHistory:function(){return null}});function G(a){return"touchstart"===a||"mousedown"===a}function H(a){return"touchmove"===a||"mousemove"===a}function I(a){return"touchend"===a||"touchcancel"===a||"mouseup"===a}
var J=["touchstart","mousedown"],K=["touchmove","mousemove"],L=["touchcancel","touchend","mouseup"],M=[],N={touchBank:M,numberActiveTouches:0,indexOfSingleActiveTouch:-1,mostRecentTimeStamp:0};function O(a){return a.timeStamp||a.timestamp}function P(a){a=a.identifier;null==a?m("138"):void 0;return a}
...
null!==g&&void 0!==g&&0!==g){h=p(g);b:{for(g=U;h;){if(g===h||g===h.alternate){g=!0;break b}h=t(h)}g=!1}if(g){a=!1;break a}}a=!0}if(a=d?Y.responderTerminate:a?Y.responderRelease:null)c=F.getPooled(a,U,c,f),c.touchHistory=S.touchHistory,x(c,A),e=T(e,c),W(null);return e},GlobalResponderHandler:null,injection:{injectGlobalResponderHandler:function(a){X.GlobalResponderHandler=a}}},Z=aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDOMComponentTree,ka=Z.getInstanceFromNode,la=Z.getNodeFromInstance;
n=Z.getFiberCurrentPropsFromNode;p=ka;q=la;module.exports={injectComponentTree:function(a){var b=a.getInstanceFromNode,c=a.getNodeFromInstance;n=a.getFiberCurrentPropsFromNode;p=b;q=c},ResponderEventPlugin:X,ResponderTouchHistoryStore:S};
